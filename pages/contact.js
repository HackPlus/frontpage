        ...
        <main>
          <section>
            <div className="absolute z-20 text-white pt-8 md:pt-20 mx-8 md:mx-14">
              <h1 className="text-4xl md:text-5xl font-medium leading-loose pb-4">Reach Out</h1>
            ...
            <div className="bg-gray relative z-0">
              <img src="/article-6.jpg" alt="Laptop" className="w-full max-h-96 mix-blend-overlay opacity-70" />
            </div>
          ...
          <svg
            ...
            className="w-full fill-current -mt-10 md:-mt-20 lg:-mt-32 relative z-20"
          >
            <path
              fill="#ffffff"
          ...
          <section className="bg-white py-14">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-0 place-items-center text-center">
              ...
              <div>
                ...
                <p>
                  <a className="text-purple font-medium" href="mailto:hello@hackplus.io">
                    hello@hackplus.io
                  </a>
                </p>
              </div>
              <div>
                ...
                <p>
                  <a href="tel:+14159388088" className="text-purple font-medium">
                    +1 (415) 938-8088
                  </a>
                </p>
