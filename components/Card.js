...
export default function Card({ title, textcolor, fillcolor, badgeText, href, cta, icon, children }) {
  return (
...
function renderIcon(icon) {
  switch (icon) {
    case 'calendar':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 20 20" fill="#1ac9e7">
